...
impl UploaderClient {
    ...
    pub fn new_testing(transport: Transport) -> Self {
        let api_endpoint = option_env!("TEST_GLOPFILE_API_ENDPOINT")
            .unwrap_or("http://localhost:8080")
            .parse()
            .expect("invalid TEST_GLOPFILE_API_ENDPOINT");
        let download_endpoint = option_env!("TEST_GLOPFILE_DOWNLOAD_ENDPOINT")
