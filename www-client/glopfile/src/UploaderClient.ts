import { UploadableFile, UploaderClient as RustUploaderClient, ProvisionedFile, UploadEventHandler } from "glopfile-www-rust";
...
export class UploaderClient {
  ...
  constructor(endpoint: URL, rust: typeof import('glopfile-www-rust')) {
