import { DownloadableFile, DownloadMeta, DownloaderClient as RustDownloaderClient, DownloadEventHandler } from "sendfile-www-rust";
...
export class DownloaderClient {
  ...
  constructor(downloadURL: URL, apiEndpoint: URL, rust: typeof import('sendfile-www-rust')) {
